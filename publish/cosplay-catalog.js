(function initCosplayCatalog(root) {
  ...
  const details = {
    ...
    '星穹铁道': [
      '高精度织物、金属、皮革与半透明薄纱，严格对应角色主辅色、金属描边和纹样分区',
      '角色专属头冠或发饰、耳饰、手套、衣襟徽饰、腰饰与阵营配件',
      '角色专属袜装或腿套、腿环、绑带与腿部装甲层次',
      '与角色服装同色系的高跟鞋或长短靴，保留鞋面纹样和金属装饰',
    ],
    '鸣潮': [
      '机能织物、哑光皮革、金属护甲与透明能量件，严格对应角色渐变、发光纹路和不对称剪裁',
      '角色专属冠饰、帽饰或发簪、耳饰、手套、腰挂与共鸣配件',
