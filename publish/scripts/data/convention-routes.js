  ...
  const nodes = {
      ...
      options: [
        ...
        option('stage-help', '去后台帮忙整理道具', '需要一定社交能力，会直接认识一名候场 Coser。',
          'coser-interact', { charm: 2, score: 5, affection: 5, meetCoser: true,
            total: 4, requires: { stat: '魅力', min: 40 }, result: '你的帮助缓解了后台的混乱。' }),
    ...
    'market-finale': {
      ...
      options: [
        ...
        option('market-help', '帮助摊主搬运收摊物料', '需要健康达到 40。',
          '', { mood: 3, reputation: 4, score: 5, finish: true,
            requires: { stat: '健康', min: 40 }, result: '你帮摊主顺利完成了收摊。' }),
      ],
    },
    'coser-interact': {
      ...
      options: [
        ...
        option('coser-lore', '聊这个角色的剧情与设定', '智力达到 40 时效果更好。',
          'coser-finale', { intelligence: 2, score: 6, affection: 10,
            requires: { stat: '智力', min: 40 }, result: '你们从角色设定一路聊到了作品细节。' }),
        option('coser-craft', '称赞服装制作与还原细节', '偏向魅力与创作交流。',
