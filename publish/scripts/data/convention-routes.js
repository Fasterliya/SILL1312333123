  ...
  const nodes = {
      ...
      options: [
        ...
        option('stage-help', '去后台帮忙整理道具', '需要一定社交能力，会直接认识一名候场 Coser。',
          'coser-interact', { charm: 2, score: 5, affection: 5, meetCoser: true,
            total: 4, requires: { stat: '交涉', min: 20 }, result: '你的帮助缓解了后台的混乱。' }),
    ...
    'market-finale': {
      ...
      options: [
        ...
        option('market-help', '帮助摊主搬运收摊物料', '需要体能达到 20。',
          '', { mood: 3, reputation: 4, score: 5, finish: true,
            strength: 1, requires: { stat: '体能', min: 20 }, result: '你帮摊主顺利完成了收摊。' }),
      ],
    },
    'coser-interact': {
