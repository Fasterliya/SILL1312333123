(function initWorldData(root) {
  ...
  C.jobs.push(
    ...
    { id: 'fashionblog', name: '时尚博主', company: '个人时尚频道', industry: '内容创作', salary: 9200, need: 60, category: '艺术', majors: ['数字媒体', '现代服务'], education: 1, tier: 2, cities: [], freelance: true, recommendedGender: '女' },
